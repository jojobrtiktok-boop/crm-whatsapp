...
export default function Header() {
  ...
  return (
    <header className="h-20 flex items-center justify-between px-4 relative"
      ...
      <div className="md:hidden absolute left-1/2 -translate-x-1/2">
        <img
          ...
          alt="Logo"
          style={{ height: '64px', objectFit: 'contain', filter: 'brightness(1.2) drop-shadow(0 0 8px rgba(129,140,248,0.5))' }}
        />
      </div>
      {/* Desktop: título */}
